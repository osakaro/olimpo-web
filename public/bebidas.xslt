...
<xsl:template match="/">
    <html>
        <head>
            <title>ELIXIRES | Olimpo Burguer</title>
        ...
        <body class="body-bebidas">
            <nav class="navbar">
                ...
                <h1 class="nav-title">
                    <span class="t-rosa">LOS</span> <span class="t-azul">ELIXIRES</span>
                </h1>
            ...
            <header class="hero">
                <div class="parallax-bg">
                    <div class="linea l1"><span>LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES</span></div>
                    <div class="linea l2"><span>🍸 LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES</span></div>
                    <div class="linea l3"><span>LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES</span></div>
                    <div class="linea l4"><span>🍸 LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES 🍸 LOS ELIXIRES</span></div>
                </div>
                <div class="hero-content">
                    <h2 class="slogan-god">
                        <span class="t-azul">BEBE COMO UN </span> 
            ...
            <main class="bebidas-grid">
                <xsl:for-each select="elixires/bebida">
