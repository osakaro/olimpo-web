    ...
    <html>
        ...
        <body class="body-entrantes">
            <nav class="navbar">
                ...
                <h1 class="nav-title">
                    <span class="t-rosa">LAS</span> <span class="t-azul">OFRENDAS</span>
                </h1>
                <div class="nav-links">
            ...
            <header class="hero">
                <div class="parallax-bg">
                    <div class="linea l1"><span>OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS</span></div>
                    <div class="linea l2"><span>🍟 OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS</span></div>
                    <div class="linea l3"><span>OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS</span></div>
                    <div class="linea l4"><span>🍟 OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS 🍟 OFRENDAS</span></div>
                </div>
                <div class="hero-content">
                    <h2 class="slogan-god">
                        <span class="t-azul">COMIENZA COMO UN </span> 
            ...
            <main class="bebidas-grid">
                <xsl:for-each select="ofrendas/plato">
